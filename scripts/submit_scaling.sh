...
#sbatch -N 1 scripts/train_cori.sh
#sbatch -N 2 scripts/train_cori.sh
#sbatch -N 4 scripts/train_cori.sh
#sbatch -N 8 scripts/train_cori.sh
#sbatch -N 16 scripts/train_cori.sh
#sbatch -N 32 scripts/train_cori.sh
